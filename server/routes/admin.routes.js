...
// 🔥 NEW: Report routes
router.get("/daily-report", auth, role(["organization"]), attendanceController.getDailyReport);
router.get("/weekly-report", auth, role(["organization"]), attendanceController.getWeeklyReport);
