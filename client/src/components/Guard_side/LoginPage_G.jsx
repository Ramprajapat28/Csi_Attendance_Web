    ...
    return (
        <>
            <div className="flex justify-center sm:items-center h-[100dvh] w-screen">
                <div className="absolute inset-0 bg-[url('/bg.jpeg')] bg-cover bg-center opacity-50 w-[100vw] hidden sm:block "></div>
                        ...
                        <div className="flex flex-col gap-[32px] sm:gap-[16px]">
                            ...
                            ">
                                <div className="flex w-max gap-[10px] h-min">
                                    <img className="h-[18px] w-[18px] my-[2px]" src="/google.png" alt="google" />
