    ...
    <div className="flex flex-col w-full h-[100dvh]">
      ...
      <div className="relative h-[100%] w-full px-[22px] py-[28px] inset-0 flex flex-col text-center justify-between">
        ...
        <button
          ...
          className="flex justify-center items-center gap-[10px] border border-[#EFF0F6] rounded-[10px] w-full h-[48px] mt-6 shadow-[0px_4px_4px_0px_#00000040] active:shadow-[0px_2px_1px_0px_#00000040] transition-all duration-100"
        >
          <img
